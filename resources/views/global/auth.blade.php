...
<head>
  ...
  <link href="{{ asset('uploads/images/favicon.png') }}" rel="icon" type="{{ mime_content_type(storage_path() . '/app/images/' . config('insura.favicon')) }}">
  <!-- Font and Icon Fonts -->
  ...
  <style type="text/css">
  	.auth{
    	...
    	background-image:url("{{asset('assets/images/insurance-bg.jpg')}}");
...
<body class="auth">
  <div class="auth-card">
    <div class="auth-branding">
      <img src="{{ asset('uploads/images/' . config('insura.logo')) }}">
    </div>
    <div class="sign-in" style="{{ $state === 'login' ? '' : 'display:none;' }}">
     <!--  <h3>{{ trans('auth.header.login', array(
      ...
      <p ><!-- {{ trans('auth.request.register') }} --> <a href="" class="text-primary auth-action ui button fluid primary" action="sign-up">{{ trans('auth.link.register') }}</a></p>
    </div>
  ...
  <script type="text/javascript">
   ...
   <script>(function(d,t,u,s,e){e=d.getElementsByTagName(t)[0];s=d.createElement(t);s.src=u;s.async=1;e.parentNode.insertBefore(s,e);})(document,'script','//livechat.lieusoft.com/home/php/app.php?widget-init.js');</script>
</body>
</html>
